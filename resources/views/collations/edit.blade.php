...
<div class="container">
        ...
        <div class="card">
            <div class="card-header text-center"><h2>{{ __('Modificacion de Cotejamiento') }}</h2></div>

            <div class="card-body ">
                <form method="POST" class="p-4" action="{{ route('updateCollation',$collation) }}">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col my-auto">                            
                            <div class="row m-2">
                                <input placeholder="{{ __('Descripcion') }}" type="text" class="form-control @error('description') is-invalid @enderror" name="description" value="{{ $collation->description }}" required autocomplete="description" autofocus>
                            </div>            
