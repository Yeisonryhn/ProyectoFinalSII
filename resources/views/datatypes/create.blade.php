...
<div class="container">
        ...
        <div class="card">
            <div class="card-header text-center"><h2>{{ __('Registro de Tipos de Datos') }}</h2></div>

            <div class="card-body ">
                <form method="POST" class="p-4" action="{{ route('storeDatatype') }}">
                    @csrf
                    <div class="row">
                        <div class="col my-auto">                            
                            ...
                            <div class="row m-2">
                                <input placeholder="{{ __('Peso') }}" type="text" class="form-control @error('weight') is-invalid @enderror" name="weight" value="{{ old('weight') }}" required autocomplete="weight" autofocus>
                            </div>
                            <div class="row m-2">
                                <input placeholder="{{ __('Ejemplo') }}" type="text" class="form-control @error('example') is-invalid @enderror" name="example" value="{{ old('example') }}" required autocomplete="example" autofocus>
                            </div>                                
